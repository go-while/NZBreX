...
# Packages to install
INSTALL_PACKAGES="aptitude gcc-aarch64-linux-gnu clang binutils-aarch64-linux-gnu mingw-w64 gcc-mingw-w64-x86-64 build-essential cmake ca-certificates curl g++-mingw-w64-x86-64 g++-mingw-w64-i686 gcc-arm-linux-gnueabi git dpkg-dev haveged musl-tools nano nginx net-tools htop psmisc sudo tar tmux unattended-upgrades vim vnstat vnstati wget zip"
